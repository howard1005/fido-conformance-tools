...
for (let dict of [USER_VERIFICATION_METHODS_TO_INT, TRANSACTION_CONFIRMATION_DISPLAY_TYPES_TO_INT, KEY_PROTECTION_TYPES_TO_INT, MATCHER_PROTECTION_TYPES_TO_INT, ATTACHMENT_HINTS_TO_INT, ALG_DIR_TO_INT, COSE_KTY_TO_INT]) {
    for (let key in dict) {
