...
/* ---------- Positive Tests ---------- */
    ...
    it(`P-4
        ...
        Get a list of FIDO characteristics and check that it contains: fidoControlPoint, fidoStatus, fidoControlPointLength, fidoServiceRevisionBitfield and u2fServiceRevision characteristics.
    ...
    `, () => {
        ...
        assert.isDefined(characteristics.fidoServiceRevision, 'For U2F u2fServiceRevision characteristic MUST be present!');
    })
    ...
    it(`P-8
       ...
       Check that fidoServiceRevisionBitfield characteristic contains "read" and "write". Read the characteristic and check that authenticator returns 1 byte that has U2F1.1(0x80) flag is set to true.
    ...
    `, () => {
        ...
        assert.isTrue(!!(serviceRevisionBitfield & 0x40), 'fidoServiceRevisionBitfield does not have U2F1.1(0x80) bitflag set!');
    })
